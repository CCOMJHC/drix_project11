...
tmux send-keys -t project11_ui "rosrun rosmon rosmon --name=rosmon_p11_operator_ui drix_project11 operator_ui.launch drixNumber:=8 backgroundChart:=/home/field/data/noaa_custom_charts/Hawaii.pdf" C-m
