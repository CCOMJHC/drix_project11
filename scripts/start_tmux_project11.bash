...
/usr/bin/tmux send-keys -t project11 "rosrun rosmon rosmon --name=rosmon_project11 drix_project11 drix.launch drixNumber:=8 operator_ip:=salmondr logDirectory:=${LOGDIR}" C-m
